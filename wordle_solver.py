...
This code was originally a JuPyter Notebook, but will run as a standalone program too...
Script downloads the word list, defines the functions, loads the dictionary, and removes words outside of the focus.
...
if yes.lower() == 'yes' or yes.lower() == 'y' :
    ...
    for i in range(pset):
        ...
        stop = i*10+10
        print(ylist[st:stop])
    print("Tip: Try to pick a word with the most popular letters above...")
